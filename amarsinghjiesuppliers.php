...
if (isset($_POST['submit'])) {
		...
		$save=mysqli_query($con, "INSERT INTO `amarsinghjiesuppliers` (`id`, `DATE`, `LITRE`, `FATE`, `FATE/RATE`, `RATE`, `TOTAL`) VALUES (NULL, '$date', '$litre', '$fate', '$rate1', '$rate', '$total')"); 
	    if($save){
...
<body>
<h1>AMAR SINGH JI</h1>
<p><es><h1>EVENING SUPPLIERS</h1></es></p>
<form method="POST" action="amarsinghjiesuppliers.php">
<p>
<label>DATE:</label>
