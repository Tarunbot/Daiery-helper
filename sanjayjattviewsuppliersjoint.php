...
<form method="POST" action="sanjayjattviewsuppliersjoint.php">
...
$query="select * from sanjayjattmsuppliers WHERE DATE between '$sd' AND '$ed'";
...
$con=mysqli_connect('localhost','root','','addcustomer');
$query="select * from sanjayjattmsuppliers ";
...
$con=mysqli_connect('localhost','root','','addcustomer');
$query="select * from sanjayjattesuppliers WHERE DATE between '$sd' AND '$ed'";
...
$con=mysqli_connect('localhost','root','','addcustomer');
$query="select * from sanjayjattesuppliers ";
