...
if (isset($_POST['submit'])) {
		...
		$save=mysqli_query($con, "INSERT INTO `sanjayjattmsuppliers` (`id`, `DATE`, `LITRE`, `FATE`, `RATE/FATE`, `RATE`, `TOTAL`) VALUES (NULL, '$date', '$litre', '$fate', '$rate1', '$rate', '$total');"); 
	    if($save){
...
<form method="POST" action="sanjayjattmsuppliers.php">
<p>
<label>DATE:</label>
