...
if (isset($_POST['submit'])) {
		...
		$save=mysqli_query($con, "INSERT INTO `sanjayjattesuppliers` (`id`, `DATE`, `LITRE`, `FATE`, `FATE/RATE`, `RATE`, `TOTAL`) VALUES (NULL, '$date', '$litre', '$fate', '$rate1', '$rate', '$total')"); 
	    if($save){
...
<form method="POST" action="sanjayjattesuppliers.php">
<p>
<label>DATE:</label>
